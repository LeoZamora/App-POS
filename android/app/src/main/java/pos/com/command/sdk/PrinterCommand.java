...
import pos.com.command.sdk.Other;
...
public class PrinterCommand {
   ...
   public static byte[] POS_Set_CodePage(int page){
	 ...
	 * @param encoding   	Print character corresponding encoding
	 * @param codepage      Set Code Page(0--255)
	 * @param nWidthTimes   double width(0--4)
	 * @param nHeightTimes  Double height(0--4)
	 * @param nFontType     font(Only valid for Ascii codes)(0,1 48,49)
	 */
	...
	/**
	 * Set the inverted printing mode (effective when the lowest bit is 1)
	 * @param brace
	 * @return
	 */
	...
	/**
	 * Choose font size (multiple height and width)
	 * @param
	 * @return
	 */
	 ...
	 * @param nErrorCorrectionLevel   Error Correct Level
	...
	public static byte[] getBarCommand(String str, int nVersion, int nErrorCorrectionLevel,
     ...
     try
     {
   	  bCodeData = str.getBytes("US-ASCII");
	...
	public static byte[] POS_Set_Font(String str, int bold, int font, int widthsize, int heigthsize){
		...
		byte[] intToWidth = { 0x00, 0x10, 0x20, 0x30 };//Maximum four times width
